  ...
  createUser = async (req: Request, res: Response)=> {
    ...
    try {
      if (hashedPassword) {
        ...
        const accessKey_expiry = process.env.ACCESS_TOKEN_EXPIRES_IN as unknown as number;
        const refreshKey_expiry = process.env.REFRESH_TOKEN_EXPIRES_IN as unknown as number;
